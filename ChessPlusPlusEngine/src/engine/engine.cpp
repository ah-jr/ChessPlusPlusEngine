...
//
/////=================================================================
//Move Engine::getNextMove(Board* board, Player team, int depth)
//{
//    SquareVec moves = nullptr;
//    SquareVec wPieces = new std::vector<Square>();
//    SquareVec bPieces = new std::vector<Square>();
//    SquareVec sPieces = (team == Player::WHITE) ? wPieces : bPieces;
//
//    for(int i = 0; i <= 7; i++)
//        for(int j = 0; j <= 7; j++)
//            if (board->squares[i][j] != nullptr)
//                if (board->squares[i][j]->team == Player::WHITE)
...
//            cur_eval += (it_m->y - it_p->y) * 0.1 * (team == Player::WHITE ? 1 : -1);  
...
//
/////=================================================================
//int Engine::getNextMoveR(const Move& move, Board* board, SquareVec wPieces, SquareVec bPieces, Player team, int depth)
//{
//    SquareVec moves = nullptr;
//    SquareVec sPieces = (team == Player::WHITE) ? wPieces : bPieces;
//
